...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="px-5 shadow-b shadow-xs sticky top-0 z-50 border-b bg-card/80 backdrop-blur-md"
      role="banner"
    >
      <nav className="container mx-auto flex items-center justify-between py-5" aria-label="Main navigation">
        ...
        <ul className="hidden md:flex items-center gap-6" role="list">
          ...
          <li>
            <Button className={"bg-primary font-semibold text-base py-2 px-5 hover:bg-primary/90 transition-colors duration-400"} size="lg">
              Get Started
            </Button>
          </li>
        </ul>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-card border-t">
          <ul className="container mx-auto flex flex-col gap-2 py-4" role="list">
            ...
            <li className="pt-2">
                <Button className={"bg-primary font-semibold text-base py-2 w-full hover:bg-primary/90 transition-colors duration-400"} size="lg">
                    Get Started
                </Button>
            </li>
          </ul>
